...
CREATE TABLE notes (
    ...
    updated_at timestamp without time zone NOT NULL,
    user_id integer,
    note_image_id character varying
);
...
CREATE INDEX index_taggings_on_note_id ON taggings USING btree (note_id);
...
--
-- Name: fk_rails_a9b34328d4; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY taggings
    ADD CONSTRAINT fk_rails_a9b34328d4 FOREIGN KEY (note_id) REFERENCES notes(id);
...
INSERT INTO schema_migrations (version) VALUES ('20160720171915'), ('20160720172134'), ('20160720172349'), ('20160720172619'), ('20160720184412'), ('20160801173916'), ('20160801175154');
